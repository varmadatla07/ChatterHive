 ...
 *
 * @description If the email domain of the user's email is "mod.chatterhive.com", the user will be
...
const addUser = async (req, res, next) => {
  ...
  const role = emailDomain === "mod.chatterhive.com" ? "moderator" : "general";
