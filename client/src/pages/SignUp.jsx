...
import Logo from "../assets/ChatterHivelogo.png";
...
const SignUpNew = () => {
  ...
  const handleEmailChange = (e) => {
    ...
    if (e.target.value.includes("mod.chatterhive.com")) {
      setIsModerator(true);
    } else {
      ...
      <div className="container mx-auto flex min-h-screen items-center justify-center px-6">
        <form className="w-full max-w-md" onSubmit={handleSubmit}>
          <div className="mx-auto flex justify-center">
            <img className="h-12 w-50 sm:h-8" style={{height: "120px", width: "auto"}} src={Logo} alt="" />
          </div>
          {signUpError &&
          ...
          <div className="mt-6">
            ...
            <div onClick={() => setIsModalOpen(true)} className="mt-6">
              {isConsentGiven && !isModerator ? (
                ...
                <p className="mt-2 cursor-pointer rounded-lg border border-violet-600 px-4 py-3 text-center text-sm font-semibold">
